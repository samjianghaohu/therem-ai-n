...
def generate_midi(midi_data, total_seconds=20):
    ...
    #avenote save generated file
    f = open("midfile/returning.mid","w+")
    magenta.music.midi_io.sequence_proto_to_midi_file(generated_sequence, f.name)
    # print("file saved")
    f.close()
